...
namespace ITour.Data.Migrations
{
    ...
    [Migration("20181215193705_Rename_Print_to_PrintTemplate")]
    partial class Rename_Print_to_PrintTemplate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITour.Models.OrderNumber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ITour.Models.PrintTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ITour.Models.Profit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<decimal>("ManualAddProfit")
                        .HasColumnType("decimal(9, 2)");

                    b.Property<decimal>("ManualBasicProfit")
                        .HasColumnType("decimal(9, 2)");

                    b.Property<decimal>("ManualProfit")
                        .HasColumnType("decimal(9, 2)");
            ...
            modelBuilder.Entity("ITour.Models.ServiceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("d4235cad-0794-4d14-b78e-c44c9e0d3a4a"), Handler = "PacketTourServices", Name = "Пакетный тур", Sequence = 1 },
                        new { Id = new Guid("20973be3-4bc3-4cb5-b29d-5b04ddbdd8eb"), Handler = "TransportServices", Name = "Транспорт", Sequence = 2 },
                        new { Id = new Guid("81e1c49e-3cae-481f-8211-330047a40e53"), Handler = "TransferServices", Name = "Трансфер", Sequence = 3 },
                        new { Id = new Guid("5e5fd872-3d6c-40b6-aaef-c3f6742f795b"), Handler = "AccomodationServices", Name = "Размещение", Sequence = 4 },
                        new { Id = new Guid("dfcc799a-760a-4918-9165-8967fcff6170"), Handler = "InsuranceServices", Name = "Страховка", Sequence = 5 },
                        new { Id = new Guid("562d76a3-0acf-4801-8562-958043fd1464"), Handler = "VisaServices", Name = "Виза", Sequence = 6 },
                        new { Id = new Guid("14e89c6f-ee6b-4b0c-ab59-cc097773f5d4"), Handler = "ExcursionServices", Name = "Экскурсия", Sequence = 7 },
                        new { Id = new Guid("9fd7b8c1-8235-4502-b49c-bae6b53631bd"), Handler = "FuelSurchargeServices", Name = "Типливный сбор", Sequence = 8 },
                        new { Id = new Guid("49cee274-009f-43bc-b88d-a968f61f1fd3"), Handler = "AdditionalServices", Name = "Доп услуга", Sequence = 9 }
                    );
                });
            ...
            modelBuilder.Entity("ITour.Models.TouroperatorBrandCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TouroperatorBrandCompanies");
                });
            ...
            modelBuilder.Entity("ITour.Services.Options.AppOptions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<bool>("IsUseCommissionReport");

                    b.Property<bool>("IsUsePayments");

                    b.Property<bool>("IsUseProfits");
            ...
            modelBuilder.Entity("ITour.Models.MaintenanceService", b =>
                {
                    b.HasBaseType("ITour.Models.Service");
                    ...
                    b.HasDiscriminator().HasValue("MaintenanceService");
                });
            ...
            modelBuilder.Entity("ITour.Models.Profit", b =>
                {
                    b.HasOne("ITour.Models.Order", "Order")
                        .WithOne("Profit")
                        .HasForeignKey("ITour.Models.Profit", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
