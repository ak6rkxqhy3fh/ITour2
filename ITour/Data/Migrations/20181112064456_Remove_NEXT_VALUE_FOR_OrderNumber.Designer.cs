...
namespace ITour.Data.Migrations
{
    ...
    [Migration("20181112064456_Remove_NEXT_VALUE_FOR_OrderNumber")]
    partial class Remove_NEXT_VALUE_FOR_OrderNumber
    {
            ...
            modelBuilder.Entity("ITour.Models.ServiceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("d4235cad-0794-4d14-b78e-c44c9e0d3a4a"), Handler = "PacketTourServices", IsDeleted = false, IsSystem = true, Name = "Пакетный тур", Sequence = 1 },
                        new { Id = new Guid("20973be3-4bc3-4cb5-b29d-5b04ddbdd8eb"), Handler = "TransportServices", IsDeleted = false, IsSystem = true, Name = "Транспорт", Sequence = 2 },
                        new { Id = new Guid("81e1c49e-3cae-481f-8211-330047a40e53"), Handler = "TransferServices", IsDeleted = false, IsSystem = true, Name = "Трансфер", Sequence = 3 },
                        new { Id = new Guid("5e5fd872-3d6c-40b6-aaef-c3f6742f795b"), Handler = "AccomodationServices", IsDeleted = false, IsSystem = true, Name = "Размещение", Sequence = 4 },
                        new { Id = new Guid("dfcc799a-760a-4918-9165-8967fcff6170"), Handler = "InsuranceServices", IsDeleted = false, IsSystem = true, Name = "Страховка", Sequence = 5 },
                        new { Id = new Guid("562d76a3-0acf-4801-8562-958043fd1464"), Handler = "VisaServices", IsDeleted = false, IsSystem = true, Name = "Виза", Sequence = 6 },
                        new { Id = new Guid("14e89c6f-ee6b-4b0c-ab59-cc097773f5d4"), Handler = "ExcursionServices", IsDeleted = false, IsSystem = true, Name = "Экскурсия", Sequence = 7 },
                        new { Id = new Guid("9fd7b8c1-8235-4502-b49c-bae6b53631bd"), Handler = "FuelSurchargeServices", IsDeleted = false, IsSystem = true, Name = "Типливный сбор", Sequence = 8 },
                        new { Id = new Guid("49cee274-009f-43bc-b88d-a968f61f1fd3"), Handler = "AdditionalServices", IsDeleted = false, IsSystem = true, Name = "Доп услуга", Sequence = 9 }
                    );
                });
