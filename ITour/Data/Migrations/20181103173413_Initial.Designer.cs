...
namespace ITour.Data.Migrations
{
    ...
    [Migration("20181103173413_Initial")]
            ...
            modelBuilder.Entity("ITour.Models.ServiceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("2875b5be-c2ac-4418-ba5f-db2418d591ed"), Handler = "PacketTourServices", IsDeleted = false, IsSystem = true, Name = "Пакетный тур" },
                        new { Id = new Guid("6a41907d-f228-47fc-b630-eb0753f09392"), Handler = "TransportServices", IsDeleted = false, IsSystem = true, Name = "Транспорт" },
                        new { Id = new Guid("fd7c3b87-70ee-4b92-b2cd-dc384fb65807"), Handler = "TransferServices", IsDeleted = false, IsSystem = true, Name = "Трансфер" },
                        new { Id = new Guid("1a1d4bf3-2aea-41a3-bacd-93995073acc1"), Handler = "AccomodationServices", IsDeleted = false, IsSystem = true, Name = "Размещение" },
                        new { Id = new Guid("7060a7e3-a2f3-47ee-a2b3-e995f8e58a52"), Handler = "InsuranceServices", IsDeleted = false, IsSystem = true, Name = "Страховка" },
                        new { Id = new Guid("3b7a174a-adb3-4aa2-b57f-276241eef31e"), Handler = "VisaServices", IsDeleted = false, IsSystem = true, Name = "Виза" },
                        new { Id = new Guid("9b17c975-ccec-4592-8f8a-59a3f1814e2e"), Handler = "ExcursionServices", IsDeleted = false, IsSystem = true, Name = "Экскурсия" },
                        new { Id = new Guid("75c018d0-f0a5-4909-83b6-c1a8b0666898"), Handler = "FuelSurchargeServices", IsDeleted = false, IsSystem = true, Name = "Типливный сбор" },
                        new { Id = new Guid("6fb3fcc5-b21a-41a5-a459-7018d238e04b"), Handler = "AdditionalServices", IsDeleted = false, IsSystem = true, Name = "Доп услуга" }
                    );
                });
